                ...
                <nav className="bg-gray-800 text-yellow-400 fixed top-0 z-50 w-full">
                    ...
                    <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden bg-gray-800`}>
                        <div className="flex flex-col space-y-4 px-4 py-2">
                            <Link to="/home" onClick={closeMenu} className="text-yellow-400 hover:text-yellow-500 px-3 py-2 text-lg font-medium">Home</Link>
                            <Link to="/about" onClick={closeMenu} className="text-yellow-400 hover:text-yellow-500 px-3 py-2 text-lg font-medium">About</Link>
                            <Link to="/contact" onClick={closeMenu} className="text-yellow-400 hover:text-yellow-500 px-3 py-2 text-lg font-medium">Contact</Link>
